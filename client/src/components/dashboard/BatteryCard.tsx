      ...
      <CardContent className="pt-4 flex flex-col justify-between flex-1 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-6 pt-4 border-t border-border/30 mt-auto">
          <div className="space-y-1">
            ...
            <div className="text-xl font-medium tabular-nums tracking-tight">13.4 <span className="text-sm text-muted-foreground font-normal">V</span></div>
          </div>
          <div className="space-y-1">
            <span className="text-xs text-muted-foreground flex items-center gap-1">
              Current
            </span>
            <div className="text-xl font-medium tabular-nums tracking-tight text-emerald-500">+12.5 <span className="text-sm text-muted-foreground font-normal text-emerald-500/70">A</span></div>
          </div>
          <div className="space-y-1">
            <span className="text-xs text-muted-foreground flex items-center gap-1">
              Power
            </span>
            <div className="text-xl font-medium tabular-nums tracking-tight text-emerald-500">+167 <span className="text-sm text-muted-foreground font-normal text-emerald-500/70">W</span></div>
          </div>
          <div className="space-y-1">
            <span className="text-xs text-muted-foreground flex items-center gap-1">
            ...
            <div className="flex gap-2">
              <div className="text-sm font-medium">T1: 22°C</div>
              <div className="text-sm font-medium">T2: 23°C</div>
            </div>
          </div>
        </div>
      </CardContent>
